...
showPages.prototype.createHtml = function(mode){ //生成html代码  
    ...
    {  
        ...
        case 5 : //模式5 (输入框) 
            ...
            if (this.pageCount < 1)  
            { 
                strHtml += '<input name="toPage" value="No Pages" class="itext" disabled="disabled" type="text">'; 
                strHtml += '<input name="go" value="GO" class="ibutton" disabled="disabled" type="button">'; 
            }  
            else  
            { 
                strHtml += '<input value="Input Page:" class="ititle" readonly="readonly" type="text">'; 
                strHtml += '<input id="pageInput' + this.showTimes + '" value="' + this.page + '" class="itext" title="Input page" onkeypress="return ' + this.name + '.formatInputPage(event);" onfocus="this.select()" type="text">'; 
                strHtml += '<input value=" / ' + this.pageCount + '" class="icount" readonly="readonly" type="text">'; 
                strHtml += '<input name="go" value="GO" class="ibutton" onclick="' + this.name + '.toPage(document.getElementById(\'pageInput' + this.showTimes + '\').value);" type="button">';  
            }  
            strHtml += '</span>';  
            break;  
        default :  
